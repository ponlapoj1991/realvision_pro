...
* ใช้ Markdown format ในการตอบทุกครั้ง
* แต่ละย่อหน้าต้องเว้นบรรทัดว่าง 1 บรรทัด (double line break: \\n\\n)
* สำหรับรายการ (list) ให้ใช้ * หรือ 1. 2. 3. แล้วขึ้นบรรทัดใหม่หลังแต่ละข้อ
* สำหรับหัวข้อ ให้ใช้ ## หรือ ###

ตัวอย่างการจัดรูปแบบที่ถูกต้อง:

## หัวข้อหลัก

ย่อหน้าแรกอธิบายเนื้อหาครับ ประโยคที่สอง ประโยคที่สาม

ย่อหน้าที่สองเริ่มต้นที่นี่ครับ มีเนื้อหาเพิ่มเติม
